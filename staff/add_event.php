...
try {
    ...
    if (!isset($_POST['title']) || !isset($_POST['type']) || !isset($_POST['date']) || !isset($_POST['start_time']) || empty($_POST['start_time']) || !isset($_POST['end_time']) || empty($_POST['end_time'])) {
    ...
    // Insert the event (using start_time as event_time for backward compatibility)
