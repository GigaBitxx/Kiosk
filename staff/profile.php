...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile_picture'])) {
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['profile_picture']['tmp_name'], $file_path)) {
            ...
            if (mysqli_query($conn, $update_query)) {
                header('Location: profile.php?updated=1&type=profile_picture');
                exit();
            } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_cover_photo'])) {
    if (isset($_FILES['cover_photo']) && $_FILES['cover_photo']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['cover_photo']['tmp_name'], $file_path)) {
            ...
            if (mysqli_query($conn, $update_query)) {
                header('Location: profile.php?updated=1&type=cover_photo');
                exit();
            } else {
...
<div class="layout">
    ...
    <div class="main">
        <div class="profile-header">
            ...
            <div class="profile-information" style="padding: 0 40px;">
